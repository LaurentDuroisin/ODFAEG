...
namespace odfaeg
{
    namespace physic {
        ...
        explicit	ForceAffector(sf::Vector3f acceleration);
        ...
        explicit	ScaleAffector(sf::Vector3f scaleFactor);
        ...
        ///
        void	setScaleFactor(sf::Vector3f scaleFactor);

        /// @brief Returns the factor by which particles are scaled every second.
        ///
        sf::Vector3f	getScaleFactor() const;


        // ---------------------------------------------------------------------------------------------------------------------------
        // Private variables
        private:
        sf::Vector3f	mScaleFactor;
        };
