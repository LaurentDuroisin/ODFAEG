...
ODFAEG is a simple, fast, cross-platform and object-oriented game engine. It provides securised networking, a game command system, components for multipass rendering, an entity system, collision detection, pathfinding, etc..., etc...
