#ifndef ODFAEG_DEPTHPEELING_RENDER_COMPONENT_HPP
#define ODFAEG_DEPTHPEELING_RENDER_COMPONENT_HPP
#include <GL/glew.h>
...
namespace odfaeg {
    namespace graphic {
        /**
          ...
          */
        class ODFAEG_GRAPHICS_API DepthPeelingRenderComponent : public HeavyComponent {
            public :
            /**
            ...
            */
            DepthPeelingRenderComponent (RenderWindow& window, int layer, std::string expression, window::ContextSettings settings = window::ContextSettings(0, 0, 4, 3, 0));
            /**
            ...
            */
            ...
            Sprite& getCopiedDepthBufferSprite();
            /**
            ...
            */
            ...
            RenderTexture copiedDepthBuffer;
            RenderTexture nbLayersCount;
            ...
            Shader simpleShader;
            Shader countNbLayers;
            Shader copyDepthBuffer;
            RenderStates currentStates; /**> the current render states.*/
            View view, previousView; /**> the view of the component.*/
            Sprite  layersCountSprite, frameBufferSprite, previousFrameBufferSprite, depthBufferSprite, frontBufferSprite, copiedDepthBufferSprite; /**> the frame, depth and normal buffer.*/
            std::string expression;
            bool update;
            bool viewUpdated, firstDraw, secondDraw, firstLoad, animationUpdated;
            static const unsigned int MAX_LAYERS = 50;
