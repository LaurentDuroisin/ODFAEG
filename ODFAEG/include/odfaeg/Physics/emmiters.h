...
namespace odfaeg
{
    namespace physic {
        ...
        public:
            ...
            void	setParticleLifetime(math::Distribution<sf::Time> particleLifetime);
            ...
            void	setParticlePosition(math::Distribution<sf::Vector3f> particlePosition);
            ...
            void	setParticleVelocity(math::Distribution<sf::Vector3f> particleVelocity);
            ...
            void	setParticleScale(math::Distribution<sf::Vector3f> particleScale);

            /// @brief Sets the initial particle color.
            /// @param particleColor Constant or function returning the initial particle color.
            void	setParticleColor(math::Distribution<sf::Color> particleColor);
        ...
        private:
            ...
            math::Distribution<sf::Time>	mParticleLifetime;
            math::Distribution<sf::Vector3f>	mParticlePosition;
            math::Distribution<sf::Vector3f>	mParticleVelocity;
            math::Distribution<float>	mParticleRotation;
            math::Distribution<float>	mParticleRotationSpeed;
            math::Distribution<sf::Vector3f>	mParticleScale;
            math::Distribution<sf::Color>	mParticleColor;
