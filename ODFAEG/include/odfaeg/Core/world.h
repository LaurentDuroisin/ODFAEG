        ...
        */
        class ODFAEG_CORE_API World {
            public :
                ...
                */
                static bool addEntity (graphic::Entity* entity) {
                    if (currentEntityManager != nullptr)
                ...
                */
                static bool containsVisibleEntity(graphic::Entity *ae) {
                    if (currentEntityManager != nullptr)
                ...
                */
                static void moveEntity(graphic::Entity* entity, float x, float y, float z){
                    if (currentEntityManager != nullptr) {
                ...
                */
                static bool collide(graphic::Entity* entity) {
                    if (currentEntityManager != nullptr) {
                        return currentEntityManager->collide(entity);
                    }
                }
                static bool collide(graphic::Entity* entity, math::Vec3f position) {
                    if (currentEntityManager != nullptr) {
                ...
                */
                static void generate_map(std::vector<graphic::Tile*> tGround, std::vector<graphic::Tile*> tWall, math::Vec2f tileSize, physic::BoundingBox zone, bool terrain3D) {
                ...
                */
                static void drawOnComponents(graphic::Drawable &drawable, int layer, graphic::RenderStates states = graphic::RenderStates::Default) {
                    if (currentEntityManager != nullptr) {
                ...
                */
                static std::vector<graphic::Entity*> getEntities(std::string expression) {
                    if (currentEntityManager != nullptr) {
                ...
                *   \return the path.
                */
                static std::vector<math::Vec2f> getPath(graphic::Entity* entity, math::Vec2f finalPos) {
                ...
                */
                ...
                static void changeVisibleEntity(graphic::Entity* toRemove, graphic::Entity* toAdd) {
                    if (currentEntityManager != nullptr) {
                ...
                static void addEntitiesUpdater(EntitySystem *eu) {
                    eus.push_back(eu);
                }
                static void addAnimUpdater(Timer *au) {
                ...
                static void removeEntityManager (std::string emName) {
                    std::vector<graphic::EntityManager*>::iterator it;
            ...
            private :
                static std::vector<EntitySystem*> eus; /**> holds every entity systems*/
                static std::vector<Timer*> aus; /**> holds every timers.*/
                static std::vector<graphic::EntityManager*> ems; /**> holds every entity managers*/
