...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    static GlContext* create(const sf::ContextSettings& settings, const WindowImpl* owner, unsigned int bitsPerPixel);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static GlContext* create(const sf::ContextSettings& settings, unsigned int width, unsigned int height);
