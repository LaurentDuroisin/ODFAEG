...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    WglContext(WglContext* shared, const sf::ContextSettings& settings, const WindowImpl* owner, unsigned int bitsPerPixel);
    ...
    ///
    ////////////////////////////////////////////////////////////
    WglContext(WglContext* shared, const sf::ContextSettings& settings, unsigned int width, unsigned int height);
...
private :
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createContext(WglContext* shared, unsigned int bitsPerPixel, const sf::ContextSettings& settings);
