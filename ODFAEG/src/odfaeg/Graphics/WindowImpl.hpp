...
///
////////////////////////////////////////////////////////////
class WindowImpl : sf::NonCopyable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    static WindowImpl* create(sf::VideoMode mode, const sf::String& title, sf::Uint32 style, const sf::ContextSettings& settings);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static WindowImpl* create(sf::WindowHandle handle);
...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool popEvent(sf::Event& event, bool block);
...
private :
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::queue<sf::Event> m_events;                     ///< Queue of available events
    JoystickState     m_joyStates[sf::Joystick::Count]; ///< Previous state of the joysticks
