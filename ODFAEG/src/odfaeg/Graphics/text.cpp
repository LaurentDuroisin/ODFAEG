        ...
        void Text::ensureGeometryUpdate()  const
        {
            ...
            for (std::size_t i = 0; i < m_string.length(); ++i)
            {
                ...
                if (underlined && (curChar == L'\n'))
                {
                    ...
                    m_vertices.append(Vertex(Vector3f(0, bottom, 0), m_color, Vector2f(1, 1)));
                    m_vertices.append(Vertex(Vector3f(0, bottom, 0), m_color, Vector2f(1, 1)));
                    m_vertices.append(Vertex(Vector3f(x, top, 0),    m_color, Vector2f(1, 1)));
                    m_vertices.append(Vertex(Vector3f(x, bottom, 0), m_color, Vector2f(1, 1)));
                }
                ...
                m_vertices.append(Vertex(Vector3f(x + left  - italic * top,    y + top, 0),    m_color, Vector2f(u1, v1)));
                m_vertices.append(Vertex(Vector3f(x + right - italic * top,    y + top, 0),    m_color, Vector2f(u2, v1)));
                m_vertices.append(Vertex(Vector3f(x + left  - italic * bottom, y + bottom, 0), m_color, Vector2f(u1, v2)));
                m_vertices.append(Vertex(Vector3f(x + left  - italic * bottom, y + bottom, 0), m_color, Vector2f(u1, v2)));
                m_vertices.append(Vertex(Vector3f(x + right - italic * top,    y + top, 0),    m_color, Vector2f(u2, v1)));
                m_vertices.append(Vertex(Vector3f(x + right - italic * bottom, y + bottom, 0), m_color, Vector2f(u2, v2)));
