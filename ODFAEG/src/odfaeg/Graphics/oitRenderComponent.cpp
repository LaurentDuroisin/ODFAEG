...
namespace odfaeg {
    namespace graphic {
        OITRenderComponent::OITRenderComponent (RenderWindow& window, int layer, std::string expression, bool useThread) :
            ...
            if (Shader::isAvailable()) {
                ...
                if (Shader::getShadingLanguageVersionMajor() >= 3 && Shader::getShadingLanguageVersionMinor() >= 3) {
                    ...
                    "coherent restrict uniform layout(size4x32) image2D iDepthBuffer;"
