...
// Headers
////////////////////////////////////////////////////////////
#include "../../../include/odfaeg/Graphics/glLoader.hpp"
#include "../../../include/odfaeg/Window/context.hpp"
static odfaeg::window::GlFunctionPointer glLoaderGetProcAddress(const char* name)
{
    return odfaeg::window::Context::getFunction(name);
}
...
void sfogl_LoadFunctions()
{
    ...
    {
        if (odfaeg::window::Context::isExtensionAvailable(ExtensionMap[i].extensionName))
