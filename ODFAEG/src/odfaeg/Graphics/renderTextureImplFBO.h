    ...
    namespace graphic {
        namespace priv
        {
            ...
            private :
                ...
                ///
                ////////////////////////////////////////////////////////////
                virtual bool create(unsigned int width, unsigned int height, sf::ContextSettings settings, bool depthAttachement, std::vector<unsigned int> textureIds, unsigned int nbChannels = 0);
