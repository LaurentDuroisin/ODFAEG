    ...
    namespace graphic {
        ...
        math::Vec3f TransformMatrix::transform (const math::Vec3f vec3) {
            if (needToUpdate3D) {
                ...
                matrix4f.m14 = -o3d.x * matrix4f.m11 - o3d.y * matrix4f.m12 - o3d.z * matrix4f.m13 + t3d.x + o3d.x * matrix4f.m11;
                ...
                matrix4f.m24 = -o3d.x * matrix4f.m21 - o3d.y * matrix4f.m22 - o3d.z * matrix4f.m23 + t3d.y + o3d.y * matrix4f.m22;
                ...
                matrix4f.m34 = -o3d.x * matrix4f.m31 - o3d.y * matrix4f.m32 - o3d.z * matrix4f.m33 + t3d.z + o3d.z * matrix4f.m33;
                matrix4f.m41 = 0;
                matrix4f.m42 = 0;
                matrix4f.m43 = 0;
                matrix4f.m44 = 1;
