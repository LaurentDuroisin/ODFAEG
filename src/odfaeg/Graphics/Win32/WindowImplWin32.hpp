...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    WindowImplWin32(sf::WindowHandle handle);
    ...
    ///
    ////////////////////////////////////////////////////////////
    WindowImplWin32(sf::VideoMode mode, const sf::String& title, sf::Uint32 style, const sf::ContextSettings& settings);
...
private :
    ...
    ///
    ////////////////////////////////////////////////////////////
    static sf::Keyboard::Key virtualKeyCodeToSF(WPARAM key, LPARAM flags);
